...
| 包 | 职责 |
|---|---|
| [`@deepseek-ai/dsh-memory-harness`](dsh-memory-harness/README.md) | MEMORY/USER 持久化、SOUL 人格注入、memory_add/replace/remove 工具、档案隔离、安全扫描 |
| [`@deepseek-ai/dsh-skill-forge`](dsh-skill-forge/README.md) | 技能写端（skill_create/patch/edit/delete）+ staged/promote + 后台 review 三路输出 |
| [`@deepseek-ai/dsh-review-core`](dsh-review-core/README.md) | 共享基建：digest / 去重 / 安全扫描 / review prompt 与解析（纯 TS，无 dsh 依赖） |
